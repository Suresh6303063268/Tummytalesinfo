...
const CulturalPractices = () => {
  return (
    <>
      {/* Hero Section with Baby Pink Theme */}
      <section className="relative bg-[#F8C8DC] text-[#5D1F3E] px-8 py-20 overflow-hidden">
      ...
      {/* Essentials Grid with Baby Pink Accents */}
      <section className="bg-[#FFE4E6] py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {essentials.map((item, index) => (
            <div key={index} className="text-center">
              ...
              />
              <h3 className="text-2xl font-extrabold text-[#5D1F3E] underline decoration-[#5D1F3E] underline-offset-[0.6rem] mb-4">
                {item.title.toUpperCase()}
              </h3>
              <div className="flex justify-center gap-4">
                <button className="border border-[#5D1F3E] px-6 py-2 rounded-md text-[#5D1F3E] font-medium hover:bg-[#5D1F3E] hover:text-white transition">
                  Book Now
                </button>
                <button className="border border-[#5D1F3E] px-6 py-2 rounded-md text-[#5D1F3E] font-medium hover:bg-[#5D1F3E] hover:text-white transition">
                  Add to Calendar
